...
module.exports = async function (deployer) {
  ...
  await skillStaking.addStake(1, 30, 4, web3.utils.toWei('0.01', 'ether'), 0);
  await skillStaking.addStake(2, 60, 4, web3.utils.toWei('0.05', 'ether'), web3.utils.toWei('1', 'ether'));
  await skillStaking.addStake(3, 120, 4, web3.utils.toWei('0.1', 'ether'), 0);
  await skillStaking.addStake(4, 180, 4, web3.utils.toWei('0.2', 'ether'), web3.utils.toWei('2', 'ether'));
